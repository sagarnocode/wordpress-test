...
function add_specific_body_class($classes)
{
	// Check if it is a specific page by ID
	// if (is_page(42)) { // Replace 42 with your specific page ID
	// 	$classes[] = 'specific-page-class';
	// }

	// Check if it is a specific page by slug
	if (is_page('contact-us')) { // Replace 'contact-us' with your specific page slug
		$classes[] = 'topBanner';
	}
