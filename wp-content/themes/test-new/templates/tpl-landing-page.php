        ...
        <div class="row bannerContent">
            ...
            <div class="col-md-7">
                <div class="bannerImgWrap">
                    ...
                    <p><?php the_sub_field( 'banner_image_detail' ); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <!-- <div class="row">
            <div class="col-md-3">
                <div class="aboutDetail">
                    <div class="iconWrap">
                        <img src="<?php echo $_asset_path ?>/assets/images/safe-space.png" />
                    </div>
                    <h4>
                        Safe Space
                    </h4>
                    <p>All members are met with and screened before admission</p>
                </div>
            </div>
            <div class="col-md-3">
                <div class="aboutDetail">
...
<?php while ( have_rows( 'new_age_wrap' ) ) : the_row(); ?>
            ...
            <div class="col-md-6">
                <div class="newAgeDetail">
                    ...
                    <ul class="checkListWrap">
                        ...
                        <?php while ( have_rows( 'match_wrap' ) ) : the_row(); ?>
                        <li>
                            <i class="checkIcon">
                            ...
                            <p><?php the_sub_field( 'check_details' ); ?></p>
                        </li>
                        <?php endwhile; ?>
                        <?php else : ?>
                        <?php // no rows found ?>
...
<?php while ( have_rows( 'member_wrap' ) ) : the_row(); ?>
            ...
            <div class="sliderTest">
                ...
                <div class="col-md-4">
                    <div class="sliderDetails">
                        ...
                        <span><?php the_sub_field( 'slider_date_name' ); ?></span>
                    </div>
                </div>
                <?php endwhile; ?>
                <?php else : ?>
...
<?php while ( have_rows( 'join_now_wrap' ) ) : the_row(); ?>
...
<?php while ( have_rows( 'trust_wrap' ) ) : the_row(); ?>
<section class="trustWrap">
    ...
    <div class="trustContainer">
        ...
        <?php while ( have_rows( 'trust_box' ) ) : the_row(); ?>
        <div class="trustBox">
            <div class="icon">
            ...
            <span><?php the_sub_field( 'trust_details_text' ); ?></span>
        </div>
        <?php endwhile; ?>
        <?php else : ?>
        <?php // no rows found ?>
...
<?php while ( have_rows( 'meet_wrap' ) ) : the_row(); ?>
